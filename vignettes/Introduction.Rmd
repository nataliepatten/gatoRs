...
## Data Processing    
We downloaded 12173 observations for <i>Galax urceolata</i> in the example above. Of these observations, only those with locality information will be helpful when investigating this species distribution. 
...
Here the current minimum distance is 1.11 km. Based on literature, we find a 2 meters (or 0.002 km) distance was enough to collect unique genets, so we do need to thin our points. 
